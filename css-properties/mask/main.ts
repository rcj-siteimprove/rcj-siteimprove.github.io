...
const tree = document.getElementById("tree") as HTMLInputElement;
const ornament = document.getElementById("ornament") as HTMLInputElement;
const gingerbread = document.getElementById("gingerbread") as HTMLInputElement;
const heart = document.getElementById("heart") as HTMLInputElement;
...
const computed = document.getElementById("computed") as HTMLTableElement;
